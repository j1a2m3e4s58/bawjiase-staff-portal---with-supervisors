import { j as jsxRuntimeExports, c as cn, d as commonjsGlobal, g as getDefaultExportFromCjs, r as reactExports, e as clsx, R as React, i as invariant, L as Link, S as SkeletonCard } from "./index-CQG1vcXg.js";
import { A as AppShell, M as Megaphone, U as Users, X } from "./AppShell-Bc4WOYvs.js";
...
import { e as createLucideIcon, i as apiGetStaffStats, j as apiGetAnnouncements, B as Button } from "./backend-client-D43GVmUU.js";
...
const GitBranchPlus = createLucideIcon("git-branch-plus", __iconNode$2);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
function StatCard({
  ...
  const trendDir = trend === void 0 ? null : trend > 0 ? "up" : trend < 0 ? "down" : "flat";
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0 flex-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-2xl font-display font-bold text-foreground leading-none", children: value }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground mt-1 truncate", children: label }),
          trend !== void 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                trendDir === "up" && /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingUp, { className: "h-3 w-3" }),
                trendDir === "down" && /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingDown, { className: "h-3 w-3" }),
                trendDir === "flat" && /* @__PURE__ */ jsxRuntimeExports.jsx(Minus, { className: "h-3 w-3" }),
...
function getDateLabel(ts) {
  ...
  const itemDay = new Date(d2.getFullYear(), d2.getMonth(), d2.getDate());
  if (itemDay.getTime() === today.getTime()) return "Today";
  if (itemDay.getTime() === yesterday.getTime()) return "Yesterday";
  return d2.toLocaleDateString("en-GH", {
    weekday: "long",
    day: "numeric",
    month: "long"
  });
...
function PollWidget({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-foreground/80", children: poll.question }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-1.5", children: options.map((opt) => {
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative px-3 py-1.5", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex items-center justify-between", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-foreground/90", children: opt.text }),
                  voted !== null && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs font-bold text-primary", children: [
                    pct,
                    "%"
                  ] })
                ] })
...
function AnnouncementCard({
  ...
  const date2 = new Date(Number(ann.createdAt)).toLocaleDateString("en-GH", {
    day: "numeric",
    month: "short",
    year: "numeric"
  });
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-2 mb-2 pr-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Badge,
            {
              variant: "outline",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-muted-foreground ml-auto pt-0.5 whitespace-nowrap", children: date2 })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-display font-semibold text-sm text-foreground leading-snug mb-1", children: ann.title }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground line-clamp-3 leading-relaxed", children: ann.content }),
...
function LeadershipSnapshot({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-3 gap-3", children: [
    {
      label: "Top Active Branch",
      value: (topBranch == null ? void 0 : topBranch[0]) ?? "—",
      sub: `${(topBranch == null ? void 0 : topBranch[1]) ?? 0} staff`,
      icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Building2, { className: "h-4 w-4 text-primary" })
    },
    {
      label: "Largest Department",
      value: (topDept == null ? void 0 : topDept[0]) ?? "—",
      sub: `${(topDept == null ? void 0 : topDept[1]) ?? 0} members`,
      icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Users, { className: "h-4 w-4 text-secondary" })
    },
    {
      label: "Active Announcements",
      value: String(announcementsCount),
      sub: "currently visible",
      icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Megaphone, { className: "h-4 w-4 text-accent-foreground" })
    }
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-9 h-9 rounded-lg bg-muted/60 flex items-center justify-center flex-shrink-0", children: item.icon }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] text-muted-foreground uppercase tracking-wider", children: item.label }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-display font-bold text-foreground truncate", children: item.value }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] text-muted-foreground", children: item.sub })
        ] })
      ]
    },
    item.label
...
function DashboardPage() {
  ...
  reactExports.useEffect(() => {
    Promise.all([apiGetStaffStats(), apiGetAnnouncements()]).then(([s2, a2]) => {
      setStats(s2);
      setAnnouncements(a2);
      setLoading(false);
    });
  ...
  function handleDismiss(id) {
    setDismissed((d2) => /* @__PURE__ */ new Set([...d2, id]));
  }
  const visibleAnnouncements = announcements.filter(
    (a2) => !a2.isDismissed && !dismissed.has(a2.id)
  );
  const branchChartData = stats ? Object.entries(stats.byBranch).map(([name, value]) => ({
    name: name.replace("KASOA ", "K."),
    value
  })) : [];
  const deptChartData = stats ? Object.entries(stats.byDepartment).sort(([, a2], [, b2]) => b2 - a2).slice(0, 6).map(([name, value]) => ({ name, value })) : [];
  const grouped = groupByDate(visibleAnnouncements);
  const dateGroups = Object.keys(grouped);
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AppShell, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto space-y-6", "data-ocid": "dashboard.page", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-0.5", children: "Welcome back — here's your portal overview" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(RoleGuard, { roles: ["SuperAdmin", "HRAdmin"], children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        Button,
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/announcements", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Megaphone, { className: "h-4 w-4 mr-2" }),
            "Manage Announcements"
          ] })
        }
      ) })
    ] }),
    loading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 lg:grid-cols-4 gap-4", children: [1, 2, 3, 4].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(SkeletonCard, { lines: 2 }, String(i))) }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            StatCard,
            {
              ...
              value: (stats == null ? void 0 : stats.active) ?? 0,
              label: "Active Staff",
              trend: 2,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            StatCard,
            {
              icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Building2, { className: "h-5 w-5 text-secondary" }),
              value: Object.keys((stats == null ? void 0 : stats.byBranch) ?? {}).length,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            StatCard,
            {
              icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Activity, { className: "h-5 w-5 text-accent-foreground" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            StatCard,
            {
              icon: /* @__PURE__ */ jsxRuntimeExports.jsx(GitBranchPlus, { className: "h-5 w-5 text-chart-4" }),
              value: `${Math.round(((stats == null ? void 0 : stats.active) ?? 0) / ((stats == null ? void 0 : stats.total) ?? 1) * 100)}%`,
    ...
    loading ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(SkeletonCard, { lines: 6, hasImage: true }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(SkeletonCard, { lines: 6, hasImage: true })
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            PortalCard,
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 220, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(PieChart, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Pie,
                  {
                    data: deptChartData,
                    ...
                    paddingAngle: 3,
                    dataKey: "value",
                    children: deptChartData.map((entry, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                      Cell,
                      {
    ...
    loading ? /* @__PURE__ */ jsxRuntimeExports.jsx(SkeletonCard, { lines: 2 }) : stats && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-ocid": "dashboard.leadership.section", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-semibold text-base text-foreground mb-3", children: "Leadership Snapshot" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        LeadershipSnapshot,
        {
          stats,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-ocid": "dashboard.announcements.section", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-semibold text-base text-foreground", children: "Announcements & News Feed" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Button,
          {
            asChild: true,
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/announcements", children: "View all" })
          }
        )
      ] }),
      loading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: [1, 2].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(SkeletonCard, { lines: 3 }, String(i))) }) : visibleAnnouncements.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
        EmptyState,
        {
      ...
      ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-6", children: dateGroups.map((group) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-3", children: grouped[group].map((ann) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          AnnouncementCard,
          {
            ann,
